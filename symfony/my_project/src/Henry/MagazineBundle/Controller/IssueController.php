...
use Henry\MagazineBundle\Entity\Issue;
use Henry\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HenryMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("HenryMagazineBundle:Issue:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HenryMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HenryMagazineBundle:Issue:edit.html.twig")
     */
