...
namespace Henry\MagazineBundle\Controller;
...
use Henry\MagazineBundle\Entity\Publication;
use Henry\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HenryMagazineBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("HenryMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HenryMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HenryMagazineBundle:Publication:edit.html.twig")
     */
